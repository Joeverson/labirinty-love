...
export default class labthIsometric {
  ...
  generate(lalo, width, height, rows, sprites) {
     ...
     * 
     */
    let plus = this.addBlocksPlus(lalo, rows, cells, sprite); // definindo a primeiro parte do map
    let less = this.addBlocksLess(lalo, rows, plus.cells, sprite); // desenhando a segunda parte do map
